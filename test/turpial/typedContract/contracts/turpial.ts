...
import ABI from '../../artifacts/turpial.json';
import QueryMethods from '../query/turpial';
import BuildExtrinsicMethods from '../build-extrinsic/turpial';
import TxSignAndSendMethods from '../tx-sign-and-send/turpial';
import MixedMethods from '../mixed-methods/turpial';
import EventsClass from '../events/turpial';
